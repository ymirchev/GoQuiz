...
func (h InteractionHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	if ok, msg := h.isValidRequest(w, r); ok {
		h.handleUserAction(w, r, msg)
	}
}

func (h InteractionHandler) isValidRequest(w http.ResponseWriter, r *http.Request) (bool, *slack.AttachmentActionCallback) {
...
func (h InteractionHandler) handleUserAction(w http.ResponseWriter, r *http.Request, msg *slack.AttachmentActionCallback) {
	fmt.Println("handleUserAction()")
